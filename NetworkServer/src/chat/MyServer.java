...
public class MyServer {
    ...
    public void broadcastPrivateMessage(String s, ClientHandler sender) throws IOException {
        for (ClientHandler client : clients) {
            if (client.equals(client.getTargetUserName())) {
                client.getPrivateMessage(s, sender.getClientUsername());
            }
